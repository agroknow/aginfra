...
<div class="container">
    ...
    <div class="a-blog-grid">
      <div class="col-lg-3">
        <?php print theme('image_style', array('style_name' => '300x140crop', 'path' => 'public://content_types/organization.jpg')); ?>
      ...
      <div class="col-lg-3">
        <?php print theme('image_style', array('style_name' => '300x140crop', 'path' => 'public://content_types/initiative.jpg')); ?>
      ...
      <div class="col-lg-3">
        <?php print theme('image_style', array('style_name' => '300x140crop', 'path' => 'public://content_types/data_point.jpg')); ?>
      ...
      <div class="col-lg-3">
        <?php print theme('image_style', array('style_name' => '300x140crop', 'path' => 'public://content_types/facility.jpg')); ?>
